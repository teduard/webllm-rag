...
const SAMPLES: SampleFile[] = [
  {
    filename: "readme.md",
    label: "Application readme",
    description: "Short app readme",
    mode: "direct",
  },
  {
    filename: "software_architecture.txt",
    label: "Software Architecture",
    description: "Wikepedia Page",
    mode: "rag",
  },
];
